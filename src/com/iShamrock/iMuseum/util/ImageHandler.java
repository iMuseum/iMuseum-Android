...
import com.iShamrock.iMuseum.acvitity.Test;
...
public class ImageHandler extends Handler {
    public static final int MSG_DELAY = 2000;
    ...
    private WeakReference<Test> weakReference;//TODO
    private int currentItem = 0;

    public ImageHandler(WeakReference<Test> weakReference) {//TODO
    ...
    public void handleMessage(Message msg) {
        ...
        Log.d(Test.LOG_TAG, "receive message " + msg.what);
        Test activity = weakReference.get();
        if (activity == null) {
